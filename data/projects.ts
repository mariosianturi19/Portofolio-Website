...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: "Full-stack Premier League information and management application for teams, players, standings, fixtures, and match scores.",
    longDescription:
      "Premier League Info System is a full-stack sports information and management application built with Next.js, TypeScript, Prisma ORM, and MySQL. It provides responsive interfaces and RESTful API routes for managing teams, players, league standings, fixtures, and match scores.",
    image: "/Premiere.webp",
    screenshots: [
      "/Premiere.webp",
      "/projects/p1.webp",
    ...
    tags: ["Next.js", "TypeScript", "Prisma ORM", "MySQL", "REST APIs"],
    ...
    highlights: [
      ...
      "Team, player, fixture, and score-management workflows",
      "RESTful API routes for teams, players, matches, and standings",
      "Prisma ORM with a relational MySQL data model",
      "Responsive interfaces with loading, error, and success states",
    ],
    caseStudy: {
      challenge:
      ...
      contributions: [
        "Built responsive Next.js interfaces for browsing league standings, team details, players, fixtures, and match results.",
        "Developed RESTful API routes for reading and managing teams, players, matches, scores, and standings.",
        "Designed a relational MySQL data model with Prisma ORM for teams, players, standings, and home-and-away matches.",
        "Implemented client-side data flows with loading, error, and success states for API-driven actions.",
      ],
      decisions: [
        "Used Next.js route handlers as an internal REST contract between the interface and data layer.",
        "Modelled team, player, standing, and match relationships in Prisma to keep data consistent across management workflows.",
        "Used TypeScript and explicit loading, error, and success states to keep API-driven interactions predictable.",
      ],
      outcome:
        "Completed a full-stack sports information and management application that combines a responsive web interface, RESTful API routes, and MySQL data management.",
      status: "Full-stack source available; a local MySQL database is required to run the data-management features.",
    },
  },
  {
    id: 4,
